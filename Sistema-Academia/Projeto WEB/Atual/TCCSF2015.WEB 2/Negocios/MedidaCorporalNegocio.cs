...
namespace Negocios
{
    public class MedidaCorporalNegocio : IDisposable
    {
        ...
        public ListaMedidaCorporal ListaMedidaCorporalAlunoWEB(int codigo)
        {
            try
            {
                acessoDadosSqlServer.LimparParametros();
                acessoDadosSqlServer.AdicionarParametros("@IDAluno", codigo);
                DataTable dataTable = acessoDadosSqlServer.ExecutarConsulta(CommandType.StoredProcedure, "uspMedidaCorporalListaAlunoWEB");
